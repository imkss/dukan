...
const perks = [
  ...
  {
    name: "Guranateed Quality",
    Icon: CheckCircle,
    description:
      "Every assets on our platform is verified by our team. Not happy yet? We offer a 30 days money back gurantee",
  },
  {
    name: "For the planet",
    Icon: Leaf,
    description:
      "We've pledged 1% of sales to the preservarion and reservation of the planet",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to Dukan. Every asset on our platform is verified by our
